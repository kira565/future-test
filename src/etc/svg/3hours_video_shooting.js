...
function VidShooting() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 40 37">
            ...
            <path
                fill="#C7C7C7"
                d="M17.957 17.445c.211-.349.525-.639.902-.835l-4.426-4.094-.903.835 4.427 4.094z"
            />
            <path
            ...
            <path
                fill="#C7C7C7"
                d="M22.042 17.445l7.135-6.599-.903-.835-6.018 5.567a.676.676 0 01-.903 0l-.87.804a2.34 2.34 0 011.56 1.063z"
            />
            <path
            ...
            <path
                fill="#C7C7C7"
                d="M34.142 5.419C30.365 1.924 25.342 0 20 0 14.658 0 9.635 1.924 5.858 5.419 2.08 8.913 0 13.559 0 18.5c0 4.942 2.08 9.587 5.858 13.081C9.635 35.076 14.658 37 20 37c5.342 0 10.365-1.924 14.142-5.419C37.92 28.087 40 23.441 40 18.5c0-4.941-2.08-9.587-5.858-13.081zM20 35.819C9.676 35.82 1.277 28.05 1.277 18.5 1.277 8.95 9.676 1.18 20 1.18S38.723 8.95 38.723 18.5 30.324 35.82 20 35.82z"
            />
            <path
            ...
            <path
                fill="#C7C7C7"
                d="M21.063 18.5c0-.543-.477-.984-1.064-.984-.586 0-1.063.442-1.063.984 0 .543.477.984 1.063.984.587 0 1.064-.441 1.064-.984z"
            />
            <path
            ...
            <path
                fill="#C7C7C7"
                d="M34.894 18.5c0-.326-.285-.59-.638-.59h-2.553c-.353 0-.639.264-.639.59 0 .326.286.59.639.59h2.553c.352 0 .638-.264.638-.59z"
            />
            <path
            ...
            <path
                fill="#C7C7C7"
                d="M20.003 28.734c-.352 0-.638.264-.638.59v2.362c0 .326.286.59.639.59.352 0 .638-.264.638-.59v-2.362c0-.326-.286-.59-.639-.59z"
            />
            <path
            ...
            <path
                fill="#C7C7C7"
                d="M8.299 17.91H5.746c-.353 0-.639.264-.639.59 0 .326.286.59.639.59h2.553c.352 0 .638-.264.638-.59 0-.326-.286-.59-.638-.59z"
            />
            <path
